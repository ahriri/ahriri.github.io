...
/* WEBPACK VAR INJECTION */(function(jQuery, __webpack_provided_window_dot_jQuery) {var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_RESULT__;var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;var require;var require;/*! classie & cbpAnimatedHeader */
...
!function (t, n) {
  ...
  function e(n) {
    return j.arr(n) ? n : (j.str(n) && (n = t(n) || n), n instanceof NodeList || n instanceof HTMLCollection ? [].slice.call(n) : [n]);
  }
  ...
  function f(t, n) {
    return j.dom(t) && r(A, n) ? "transform" : j.dom(t) && (t.getAttribute(n) || j.svg(t) && t[n]) ? "attribute" : j.dom(t) && "transform" !== n && c(t, n) ? "css" : null != t[n] ? "object" : void 0;
  }
  ...
  function l(t, n) {
    switch (f(t, n)) {
      case "transform":
        return function (t, n) {
          var e,
              r = -1 < (e = n).indexOf("translate") ? "px" : -1 < e.indexOf("rotate") || -1 < e.indexOf("skew") ? "deg" : void 0;
          if (r = -1 < n.indexOf("scale") ? 1 : 0 + r, !(t = t.style.transform)) return r;

          for (var a = [], i = [], u = [], o = /(\w+)\((.+?)\)/g; a = o.exec(t);) i.push(a[1]), u.push(a[2]);
  ...
  function d(t, n) {
    ...
    switch (n = parseFloat(n), t = parseFloat(t.replace(e[0], "")), e[0][0]) {
      case "+":
        return n + t;
  ...
  function h(t, n) {
    var e = /-?\d*\.?\d+/g;
    if (t = p(t) ? t.totalLength : t, j.col(t)) n = j.rgb(t) ? t : j.hex(t) ? function (t) {
      ...
      if (e = parseInt(e[3]) / 100, 0 == r) r = e = t = e;else {
        var a = .5 > e ? e * (1 + r) : e + r - e * r,
            i = 2 * e - a;
        r = n(i, a, t + 1 / 3), e = n(i, a, t), t = n(i, a, t - 1 / 3);
      }
  ...
  function y(t, n) {
    ...
    if (j.arr(t)) {
      var i = t.length;
      2 !== i || j.obj(t[0]) ? j.fnc(n.duration) || (r.duration = n.duration / i) : t = {
        value: t
      };
    }

    return e(t).map(function (t, e) {
      return e = e ? 0 : n.delay, t = j.obj(t) && !p(t) ? t : {
        value: t
      }, j.und(t.delay) && (t.delay = e), t;
    }).map(function (t) {
      return u(t, r);
    });
  }
  ...
  function b(t, n) {
    ...
    return t.tweens.map(function (r) {
      ...
      i = o(c) || o(u) || o(i);
      return r.isPath = p(a), r.from = h(u, i), r.to = h(c, i), r.start = e ? e.end : t.offset, r.end = r.start + r.delay + r.duration, r.easing = function (t) {
        return j.arr(t) ? I.apply(this, t) : k[t];
      }(r.easing), r.elasticity = (1e3 - Math.min(Math.max(r.elasticity, 1), 999)) / 1e3, j.col(r.from.original) && (r.round = 1), e = r;
    });
  }

  function w(t, n, e) {
    var r = "delay" === t ? Math.min : Math.max;
    return n.length ? r.apply(Math, n.map(function (n) {
      return n[t];
    })) : e[t];
  }
  ...
  function x(t) {
    var e,
        ...
        s = i(O, t),
        c = i($, t),
        l = (r = t.targets, (a = v(r)).map(function (t, n) {
      return {
        target: t,
        id: n,
        total: a.length
    ...
    for (e in t) p.hasOwnProperty(e) || "targets" === e || d.push({
      name: e,
      offset: p.offset,
      tweens: y(t[e], c)
    });
    ...
    return o = d, u(s, {
      animatables: l,
      animations: t = n(l.map(function (t) {
  ...
  function M(t) {
    ...
    function r(t) {
      for (var n = 0, e = {}, r = p.animations, a = {}; n < r.length;) {
        var i = r[n],
            u = i.animatable,
            o = i.tweens;
        a.tween = o.filter(function (n) {
          return t < n.end;
        })[0] || o[o.length - 1], a.isPath$0 = a.tween.isPath, a.round = a.tween.round, a.eased = a.tween.easing(Math.min(Math.max(t - a.tween.start - a.tween.delay, 0), a.tween.duration) / a.tween.duration, a.tween.elasticity), o = g(a.tween.to.numbers.map(function (t) {
          return function (n, e) {
            return n = (e = t.isPath$0 ? 0 : t.tween.from.numbers[e]) + t.eased * (n - e), t.isPath$0 && (n = m(t.tween.value, n)), t.round && (n = Math.round(n * t.round) / t.round), n;
          };
        }(a)), a.tween.to.strings), F[i.type](u.target, i.property, o, e, u.id), i.currentValue = o, n++, a = {
          isPath$0: a.isPath$0,
          tween: a.tween,
          eased: a.eased,
          round: a.round
      ...
      if (e) for (var s in e) P || (P = c(document.body, "transform") ? "transform" : "-webkit-transform"), p.animatables[s].target.style[P] = e[s].join(" ");
    ...
    function u(t) {
      var u = p.duration,
          ...
          g = p.reversed,
          v = e(t);
      if ((v = Math.min(Math.max(v, 0), u)) > c && v < u ? (r(v), !p.began && v >= m && (p.began = !0, a("begin")), a("run")) : (v <= c && 0 !== h && (r(0), g && i()), v >= u && h !== u && (r(u), g || i())), t >= u && (p.remaining ? (s = o, "alternate" === p.direction && (p.reversed = !p.reversed)) : (p.pause(), l(), d = n(), p.completed || (p.completed = !0, a("complete"))), f = 0), p.children) for (t = p.children, u = 0; u < t.length; u++) t[u].seek(v);
      a("update");
    }
    ...
    return p.reset = function () {
      var t = p.direction,
          n = p.loop;
      p.currentTime = 0, p.progress = 0, p.paused = !0, p.began = !1, p.completed = !1, p.reversed = "reverse" === t, p.remaining = "alternate" === t && 1 === n ? 2 : n;
    }, p.tick = function (t) {
      ...
      p.paused && (p.paused = !1, s = 0, f = p.completed ? 0 : e(p.currentTime), L.push(p), T || E());
    }, p.reverse = function () {
  ...
  var P,
    ...
    return function (n, e, r, a) {
      if (0 <= n && 1 >= n && 0 <= r && 1 >= r) {
        ...
        if (n !== e || r !== a) for (var u = 0; 11 > u; ++u) i[u] = t(.1 * u, n, r);
        return function (u) {
          if (n === e && r === a) return u;
          if (0 === u) return 0;
          if (1 === u) return 1;

          for (var o = 0, s = 1; 10 !== s && i[s] <= u; ++s) o += .1;

          s = o + (u - i[--s]) / (i[s + 1] - i[s]) * .1;
          var c = 3 * (1 - 3 * r + 3 * n) * s * s + 2 * (3 * r - 6 * n) * s + 3 * n;

          if (.001 <= c) {
            for (o = 0; 4 > o && 0 !== (c = 3 * (1 - 3 * r + 3 * n) * s * s + 2 * (3 * r - 6 * n) * s + 3 * n); ++o) {
              var f = t(s, n, r) - u;
              s = s - f / c;
            }

            u = s;
          } else if (0 === c) u = s;else {
            s = o, o = o + .1;
            var l = 0;

            do {
              f = s + (o - s) / 2, c = t(f, n, r) - u, 0 < c ? o = f : s = f;
      ...
      k = function () {
    function t(t, n) {
      return 0 === t || 1 === t ? t : -Math.pow(2, 10 * (t - 1)) * Math.sin(2 * (t - 1 - n / (2 * Math.PI) * Math.asin(1)) * Math.PI / n);
    }
    ...
    var n,
      ...
      InOut: [[.455, .03, .515, .955], [.645, .045, .355, 1], [.77, 0, .175, 1], [.86, 0, .07, 1], [.445, .05, .55, .95], [1, 0, 0, 1], [.785, .135, .15, .86], [.68, -.55, .265, 1.55], function (n, e) {
        return .5 > n ? t(2 * n, e) / 2 : 1 - t(-2 * n + 2, e) / 2;
      }]
    },
        a = {
    ...
    for (n in r) i.type = n, r[i.type].forEach(function (t) {
      return function (n, r) {
        a["ease" + t.type + e[r]] = j.fnc(n) ? n : I.apply($jscomp$this, n);
      };
    }(i)), i = {
      type: i.type
    };
  ...
  return M.version = "2.0.1", M.speed = 1, M.running = L, M.remove = function (t) {
    t = v(t);

    for (var n = L.length - 1; 0 <= n; n--) for (var e = L[n], a = e.animations, i = a.length - 1; 0 <= i; i--) r(t, a[i].animatable.target) && (a.splice(i, 1), a.length || e.pause());
  }, M.getValue = l, M.path = function (n, e) {
  ...
  }, M.bezier = I, M.easings = k, M.timeline = function (t) {
    var n = M(t);
    return n.duration = 0, n.children = [], n.add = function (t) {
      return e(t).forEach(function (t) {
        var e = t.offset,
            r = n.duration;
        t.autoplay = !1, t.offset = j.und(e) ? r : d(e, r), (t = M(t)).duration > r && (n.duration = t.duration), n.children.push(t);
      }), n;
    }, n;
  ...
  $.fn.extend({
    ...
    checkForVisiblilityChange: function (callback) {
      ...
      while (elem = this[i++]) {
        ...
        curValue !== elem.lastVisibility && (elem.lastVisibility = curValue, typeof callback === "function" && callback.apply(this, [new jQuery.Event('visibilityChanged'), curValue ? "shown" : "hidden"]), function (elem, curValue, w) {
    ...
    2: [function (t, e, i) {
      ...
      function a(t) {
        if (t) {
          ...
          } else if (a = t.match(/^#([a-fA-F0-9]{6})$/i)) for (a = a[1], o = 0; o < e.length; o++) e[o] = parseInt(a.slice(2 * o, 2 * o + 2), 16);else if (a = t.match(/^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/i)) {
        ...
        t.controllers.bar = t.DatasetController.extend({
          ...
          calculateBarIndexPixels: function (t, e, i) {
            var n,
                ...
                y,
                k = i.scale.options,
                M = "flex" === k.barThickness ? (h = e, g = k, v = (m = (f = i).pixels)[h], b = h > 0 ? m[h - 1] : null, x = h < m.length - 1 ? m[h + 1] : null, y = g.categoryPercentage, null === b && (b = v - (null === x ? f.end - v : x - v)), null === x && (x = v + v - b), p = v - (v - b) / 2 * y, {
        ...
        t.Tooltip = a.extend({
          ...
          update: function (e) {
            ...
            if (I.length) {
              ...
              for (i = 0, n = I.length; i < n; ++i) z.push((y = void 0, k = void 0, y = (x = I[i])._xScale, k = x._yScale || x._scale, M = x._index, w = x._datasetIndex, {
    ...
    47: [function (t, e, i) {
      ...
      e.exports = {
        ...
        initialize: function () {
          ...
          t = "@-webkit-keyframes " + s + "{" + i + "}@keyframes " + s + "{" + i + "}." + r + "{-webkit-animation:" + s + " 0.001s;animation:" + s + " 0.001s;}", e = this._style || document.createElement("style"), this._style || (this._style = e, t = "/* Chart.js */\n" + t, e.setAttribute("type", "text/css"), document.getElementsByTagName("head")[0].appendChild(e)), e.appendChild(document.createTextNode(t));
        },
        ...
        addEventListener: function (t, e, i) {
          ...
          if ("resize" !== e) {
            ...
            h(C, e, (_.proxies || (_.proxies = {}))[t.id + "_" + e] = function (e) {
              var a, o, r;
              i((o = t, g(u[(a = e).type] || a.type, o, (r = n.getRelativePosition(a, o)).x, r.y, a)));
            });
          } else c = i, f = t, w = (d = C)[a] || (d[a] = {}), S = w.resizer = function (t) {
            ...
            if (w.resizer) return c(g("resize", f));
          }, v = !1, b = [], function () {
            b = Array.prototype.slice.call(arguments), m = m || this, v || (v = !0, n.requestAnimFrame.call(window, function () {
              v = !1, p.apply(m, b);
            }));
          })), y = function () {
            if (w.resizer) {
              var t = d.parentNode;
              t && t !== S.parentNode && t.insertBefore(S, t.firstChild), S._reset();
            }
          }, k = (x = d)[a] || (x[a] = {}), M = k.renderProxy = function (t) {
            t.animationName === s && y();
          }, n.each(l, function (t) {
            h(x, t, M);
          }), k.reflow = !!x.offsetParent, x.classList.add(r);
        },
        removeEventListener: function (t, e, i) {
          ...
          if ("resize" !== e) {
            var p = ((i[a] || {}).proxies || {})[t.id + "_" + e];
            p && f(g, e, p);
          } else c = (o = g)[a] || {}, h = c.resizer, delete c.resizer, u = (s = o)[a] || {}, (d = u.renderProxy) && (n.each(l, function (t) {
            f(s, t, d);
          }), delete u.renderProxy), s.classList.remove(r), h && h.parentNode && h.parentNode.removeChild(h);
        }
    ...
    50: [function (t, e, i) {
      ...
      e.exports = {
        ...
        afterDatasetsUpdate: function (t, e) {
          ...
          for (n = 0; n < g; ++n) (d = m[n]) && (d.fill = u(m, n, p), d.boundary = l(d), d.mapper = (f = void 0, f = "dataset", !1 === (h = (c = d).fill) ? null : (isFinite(h) || (f = "boundary"), r[f](c))));
        },
        ...
        var e = t.Scale.extend({
          ...
          buildTicks: function () {
            ...
            switch (S.ticks.source) {
              case "data":
                _ = k._timestamps.data;
                break;

              case "labels":
                _ = k._timestamps.labels;
                break;
                ...
                _ = function (t, e, i, a) {
                  ...
                  for (f || (f = function (i, n, a, o) {
                    var r,
                        ...
                        f = h.size,
                        g = h.steps;
                    if (!g) return Math.ceil(d / (o * f));

                    for (r = 0, s = g.length; r < s && (u = g[r], !(Math.ceil(d / (f * u)) <= o)); ++r);

                    return u;
                  }(0, 0, 0, i)), g && (b = b.isoWeekday(g), x = x.isoWeekday(g)), b = b.startOf(g ? "day" : c), (x = x.startOf(g ? "day" : c)) < e && x.add(1, c), r = n(b), m && h && !g && !d.round && (r.startOf(h), r.add(~~((b - r) / (v.size * f)) * f, c)); r < x; r.add(f, c)) y.push(+r);

                  return y.push(+r), y;
                }(M, w, k.getLabelCapacity(M), S);

            }

            for ("ticks" === S.bounds && _.length && (M = _[0], w = _[_.length - 1]), M = g(C.min, k) || M, w = g(C.max, k) || w, t = 0, e = _.length; t < e; ++t) (i = _[t]) >= M && i <= w && D.push(i);

            return k.min = M, k.max = w, k._unit = C.unit || function (t, e, i, a) {
              var o,
                  r,
            ...
            }(D, C.minUnit, k.min, k.max), k._majorUnit = p(k._unit), k._table = function (t, e, i, n) {
              ...
              return u;
            }(k._timestamps.data, M, w), k._offsets = (a = k._table, r = D, d = M, c = w, x = 0, y = 0, (m = S).offset && r.length && (m.time.min || (v = r.length > 1 ? r[1] : c, b = r[0], x = (h(a, "time", v, "pos") - h(a, "time", b, "pos")) / 2), m.time.max || (v = r[r.length - 1], b = r.length > 1 ? r[r.length - 2] : d, y = (h(a, "time", v, "pos") - h(a, "time", b, "pos")) / 2)), {
              left: x,
              right: y
            }), k._labelFormat = function (t, e) {
              var i,
                  n,
                  a,
                  o = t.length;
            ...
            }(k._timestamps.data, C), function (t, e) {
              var i,
                  a,
                  o,
                  r,
...
!function (t) {
  ...
  r.VERSION = "0.11.5", r.INPUT_SELECTOR = ':input:not([type="hidden"], [type="submit"], [type="reset"], button)', r.FOCUS_OFFSET = 20, r.DEFAULTS = {
    ...
    function o(t) {
      return a = t, r.data(a + "-error") || ((e = r[0].validity).typeMismatch ? r.data("type-error") : e.patternMismatch ? r.data("pattern-error") : e.stepMismatch ? r.data("step-error") : e.rangeOverflow ? r.data("max-error") : e.rangeUnderflow ? r.data("min-error") : e.valueMissing ? r.data("required-error") : null) || r.data("error");
      var e, a;
    }
